<?php
    ...
    class Web extends AuthAbstract {
        ...
        protected function init() {
            parent::init();
            $authKey    = Request::instance()->cookie( static::AUTH_COOKIE_KEY, null );
            if( null !== $authKey ) {
        ...
        public function authenticate( $login = null, $password = null ) {
            ...
            if( $auth->id() > 0 ) {
                ...
                $expiredDate    = new DateTime( '+ 30 days ' );

                Cookie::set( static::AUTH_COOKIE_KEY, $cookieHash, $expiredDate->getTimestamp() );
                ...
                SessionModel::insert( [
                    ...
                    'user_ip'       => $this->userIp,
                    'expired_date'  => $expiredDate->mySQL(),
        ...
        public function logout() {
            $cookieKey  = Request::instance()->cookie( static::AUTH_COOKIE_KEY, -1 );

            $date       = new DateTime();
            Cookie::set( static::AUTH_COOKIE_KEY, 'none', $date->getTimestamp() );
            SessionModel::query()->whereUniKey( $cookieKey )->delete();
